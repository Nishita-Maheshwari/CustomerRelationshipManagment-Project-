				...
				<div class="col-6 d-flex justify-content-center">
					<div class="addemp_div_design bg-light">
						...
						<form action="addEmpForm" method="post">
							<div class="mb-3">
								<label class="form-label">Enter Full Name</label> <input type="text"
									name="name1" class="form-control" />
							</div>
							<div class="mb-3">
								<label class="form-label">Enter Email</label> <input type="text"
							...
							<div class="mb-3">
								<label class="form-label">Enter Phone No.</label> <input
									type="text" name="phoneno1" class="form-control" />
							</div>
